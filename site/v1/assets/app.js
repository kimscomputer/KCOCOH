  ...
  const translations = {
    ko: {
      ...
      text: {
        ...
        'next.card1Text': '어린이들이 예배와 말씀, 찬양과 활동을 통해 하나님의 사랑을 배우고 믿음 안에서 자라도록 돕습니다.',
        'next.card1Time': '주일 11:00 AM · 어린이 예배와 교육',
        'next.card2Meta': 'Youth Group',
        'next.card2Title': '중고등부 (Youth Group)',
        'next.card2Text': '청소년들이 말씀과 기도, 또래 공동체 안에서 복음의 정체성을 세우고 삶으로 믿음을 배워갑니다.',
        'next.card2Time': '금요일 7:00 PM · 주일 모임',
        'next.card3Meta': 'Young Adults',
        'next.card3Title': '청년부',
        'next.card3Text': '대학생과 청년들이 예배, 말씀, 소그룹과 교제 가운데 신앙과 삶의 방향을 함께 세워갑니다.',
        'next.card3Time': '금요일 7:00 PM · 소그룹과 교제',
        'next.card4Meta': 'English Ministry',
        'next.card4Title': '영어부 (English Ministry)',
        'next.card4Text': '영어권 성도와 가정, 학생들이 함께 예배하고 말씀 안에서 자라며 공동체 안에서 섬기고 연결됩니다.',
    ...
    en: {
      ...
      text: {
        ...
        'next.card1Text': 'Children learn God’s love and grow in faith through worship, the Word, praise, and age-appropriate activities.',
        'next.card1Time': 'Sunday 11:00 AM · worship and learning',
        'next.card2Meta': 'Youth Group',
        'next.card2Title': 'Youth Group',
        'next.card2Text': 'Middle and high school students build gospel identity through the Word, prayer, and peer community.',
        'next.card2Time': 'Friday 7:00 PM · Sunday gathering',
        'next.card3Meta': 'Young Adults',
        'next.card3Title': 'Young Adults',
        'next.card3Text': 'College students and young adults grow together through worship, the Word, small groups, and fellowship.',
        'next.card3Time': 'Friday 7:00 PM · small groups',
        'next.card4Meta': 'English Ministry',
        'next.card4Title': 'English Ministry',
        'next.card4Text': 'English-speaking members, families, and students worship together, grow in the Word, and connect through service and community.',
        'next.card4Time': 'Sunday 9:00 / 11:00 AM',
        'next.card5Meta': 'Korean School',
    ...
    zh: {
      ...
      text: {
        ...
        'next.card1Text': '儿童通过礼拜、圣经话语、赞美和适龄活动学习神的爱，并在信仰中成长。',
        'next.card1Time': '主日 11:00 AM · 儿童礼拜与学习',
        'next.card2Meta': 'Youth Group',
        'next.card2Title': '中高等部 (Youth Group)',
        'next.card2Text': '中学生和高中生在圣经话语、祷告和同伴共同体中建立福音身份。',
        'next.card2Time': '周五 7:00 PM · 主日聚会',
        'next.card3Meta': 'Young Adults',
        'next.card3Title': '青年部',
        'next.card3Text': '大学生和青年通过礼拜、圣经话语、小组与团契一起成长。',
        'next.card3Time': '周五 7:00 PM · 小组团契',
        'next.card4Meta': 'English Ministry',
        'next.card4Title': '英语部 (English Ministry)',
        'next.card4Text': '英语会众、家庭和学生一起敬拜，在圣经话语中成长，并通过服事与共同体连接。',
        'next.card4Time': 'Sunday 9:00 / 11:00 AM',
        'next.card5Meta': 'Korean School',
    ...
    es: {
      ...
      text: {
        ...
        'next.card1Text': 'Los niños aprenden el amor de Dios y crecen en la fe por medio del culto, la Palabra, la alabanza y actividades apropiadas para su edad.',
        'next.card1Time': 'Domingo 11:00 AM · culto y aprendizaje',
        'next.card2Meta': 'Youth Group',
        'next.card2Title': 'Grupo juvenil (Youth Group)',
        'next.card2Text': 'Los estudiantes de secundaria y preparatoria forman identidad en el evangelio por medio de la Palabra, la oración y la comunidad.',
        'next.card2Time': 'Viernes 7:00 PM · reunión dominical',
        'next.card3Meta': 'Young Adults',
        'next.card3Title': 'Jóvenes adultos',
        'next.card3Text': 'Universitarios y jóvenes adultos crecen juntos por medio del culto, la Palabra, grupos pequeños y comunión.',
        'next.card3Time': 'Viernes 7:00 PM · grupos pequeños',
        'next.card4Meta': 'English Ministry',
        'next.card4Title': 'English Ministry',
        'next.card4Text': 'Miembros, familias y estudiantes de habla inglesa adoran juntos, crecen en la Palabra y se conectan por medio del servicio y la comunidad.',
        'next.card4Time': 'Sunday 9:00 / 11:00 AM',
        'next.card5Meta': 'Korean School',
        'next.card5Title': 'KCC Korean School',
