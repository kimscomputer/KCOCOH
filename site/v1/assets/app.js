  ...
  const translations = {
    ko: {
      ...
      text: {
        ...
        'next.card1Text': '유치부와 초등부가 예배와 점심, 성경 수업을 통해 예수님의 복음을 배우는 어린이 사역입니다. 유치부는 구관 지하에서 Gospel Light 교재로 예수님과 예배를 배우고, 초등부는 소예배실 예배 후 친교와 성경공부로 이어집니다.',
        'next.card1Time': '유치부 10:30–12:00 · 초등부 10:30–12:45',
        'next.card2Meta': 'Youth Group',
        'next.card2Title': '중고등부 (Youth Group)',
        'next.card2Text': '6–12학년 학생들이 함께 예배하고 말씀을 배우는 공동체입니다. 주일에는 다목적 체육관에서 예배드리고, 금요일 밤에는 찬양과 예배로 시작해 소그룹 성경공부와 나눔, 기도로 이어집니다.',
        'next.card2Time': '주일 10:30 AM · 금요일 7:00 PM EM 성전',
        ...
        'next.card3Time': '청년부 예배 금요일 7:00 PM 소예배실 · 기도회 주일 7:00 PM 본당',
        'next.card4Meta': 'English Ministry',
        'next.card4Title': '영어부 (English Ministry)',
        'next.card4Text': 'KCCEM은 다양한 민족과 배경의 사람들이 함께 모여 하나님을 예배하고 말씀을 배우는 영어권 공동체입니다. 영어권 성도와 가정, 학생들이 예배와 교제 안에서 함께 자라도록 섬깁니다.',
        'next.card4Time': 'English Ministry · Sunday streams',
    ...
    en: {
      ...
      text: {
        ...
        'next.card1Time': 'Pre-K 10:30–12:00 · Elementary 10:30–12:45',
        'next.card2Meta': 'Youth Group',
        ...
        'next.card4Text': 'KCCEM is the English Ministry of KCC, a place for people of all ethnicities and backgrounds to come together to worship and learn about God. English-speaking members, families, and students grow together in worship and community.',
        'next.card4Time': 'English Ministry · Sunday streams',
    ...
    zh: {
      ...
      text: {
        ...
        'next.card1Time': '幼儿部 10:30–12:00 · 小学部 10:30–12:45',
        'next.card2Meta': 'Youth Group',
        ...
        'next.card2Time': '主日 10:30 AM · 周五 7:00 PM EM 礼拜堂',
        'next.card3Meta': 'Young Adults',
        'next.card3Title': '青年部',
        ...
        'next.card4Text': 'KCCEM 是 KCC 的英语事工，欢迎不同族裔和背景的人一起敬拜并学习认识神。英语会众、家庭和学生在礼拜与共同体中一同成长。',
        'next.card4Time': 'English Ministry · Sunday streams',
    ...
    es: {
      ...
      text: {
        ...
        'next.card1Time': 'Pre-K 10:30–12:00 · Primaria 10:30–12:45',
        'next.card2Meta': 'Youth Group',
        ...
        'next.card4Meta': 'English Ministry',
        'next.card4Title': 'English Ministry',
        'next.card4Text': 'KCCEM es el English Ministry de KCC, un lugar donde personas de todas las etnias y trasfondos se reúnen para adorar y aprender acerca de Dios. Miembros, familias y estudiantes de habla inglesa crecen juntos en culto y comunidad.',
        'next.card4Time': 'English Ministry · Sunday streams',
